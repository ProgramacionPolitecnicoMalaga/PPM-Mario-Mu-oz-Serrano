...
public class DialogoRegistrar extends JDialog {
    ...
    private JComboBox comboBoxAlgoritmo;
    ...
    private void onOK() {
        if (!textFieldNombre.getText().equals("")&&passwordFieldContraseña.getPassword().length!=0) {
            ...
            datos.put("algoritmo", getAlgoritmoElegido());
    ...
    private String getAlgoritmoElegido() {
        int algoritmoElegido = comboBoxAlgoritmo.getSelectedIndex();
        switch (algoritmoElegido) {
            case 1: return ControladorCredenciales.ALGORITMO_SHA512;
            case 2: return ControladorCredenciales.ALGORITMO_BCRYPT;
            default: return ControladorCredenciales.ALGORITMO_SHA512;
        }
    }

    private void createUIComponents() {
        comboBoxAlgoritmo = new JComboBox();
        comboBoxAlgoritmo.addItem("Selecciona algoritmo");
        comboBoxAlgoritmo.addItem(ControladorCredenciales.ALGORITMO_SHA512);
        comboBoxAlgoritmo.addItem(ControladorCredenciales.ALGORITMO_BCRYPT);
    }
}
